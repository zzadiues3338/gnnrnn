...
parser.add_argument('-num_weather_vars', "--num_weather_vars", default=11, type=int, help='Number of daily weather vars, from PRISM and NLDAS. There were 6 in the CNN-RNN paper, 23 in our new dataset.')
parser.add_argument('-num_management_vars', "--num_management_vars", default=0, type=int, help='Number of weekly management (crop progress) variables. There are 96 in our new dataset.')
parser.add_argument('-num_soil_vars', "--num_soil_vars", default=0, type=int, help='Number of depth-dependent soil vars, from gSSURGO. There were 10 in the CNN-RNN paper, 20 in our new dataset.')
parser.add_argument('-num_extra_vars', "--num_extra_vars", default=0, type=int, help='Number of extra vars, e.g. gSSURGO variables that are not dependent on depth. There were 5 in the CNN-RNN paper, 6 in our new dataset.')
