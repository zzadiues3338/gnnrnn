...
python main.py --dataset ${crop}_weekly --crop_type $crop --test_year $year \
    ...
    -cp model/corn_weekly/2022/gnn-rnn_bs-32_lr-0.0001_maxepoch-20_sche-cosine_T0-100_etamin-1e-06_step-25_gamma-1.0_dropout-0.1_sleep-100_testyear-2022_aggregator-pool_encoder-cnn_trainweekstart-52_len-5_weightdecay-1e-05_seed-0_no-management/model-17